    ...
    const result = await db.$transaction(async (tx) => {
      ...
      const company = await tx.company.create({
        data: {
          ...
          logoUrl: logoUrl?.trim() || "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=300&q=80",
          bannerUrl: bannerUrl?.trim() || "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1600&q=80",
